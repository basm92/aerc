...
```{r}
roads_url  <- "https://wxs.ign.fr/pfinqfa9win76fllnimpfmbi/telechargement/inspire/ROUTE500-France-2021$ROUTE500_3-0__SHP_LAMB93_FXX_2021-11-03/file/ROUTE500_3-0__SHP_LAMB93_FXX_2021-11-03.7z"
...
## Step 5: Download municipality boundaries from GADM

`geodata::gadm()` downloads administrative boundaries directly from the GADM database. Level 5 gives us French communes (the finest level). We reproject to match the roads CRS and compute each commune's total area in m².

```{r}
france_communes <- geodata::gadm(country = "FRA", level = 5, path = tmp) |>
  st_as_sf() |>
  st_transform(crs) |>
